    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('tracking') }}">
          <i class="bi bi-tag-fill"></i><span style="font-size: 0.8rem;">Asset Tracking Management</span>
        </a>
      </li>
      {{-- <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-assetTrack" data-bs-toggle="collapse" href="#">
          <i class="bi bi-tag-fill"></i><span style="font-size: 0.8rem;">Asset Tracking Management</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-assetTrack" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a  href="{{ route('tracking') }}">
              <i class="bi bi-circle"></i><span style="font-size: 0.8rem;">Overview</span>
            </a>
          </li>
        </ul>
      </li> --}}
