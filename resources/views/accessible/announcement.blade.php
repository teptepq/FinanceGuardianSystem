            ...
            <div class="card">
              <div class="card-body">
                ...
                {{-- <p>This is an examle page with no contrnt. You can use it as a starter for your custom pages.</p> --}}
                 ...
                 <button type="button" class="btn btn-primary rounded-pill" data-bs-toggle="modal" data-bs-target="#largeModal" id='compose'>Compose</button>
                 <table id="dynamic_Datable" class="datatable" style="font-size: 12.5px;">
                  <thead>
                      <tr>
                          <th>id</th>
                          <th>Name</th>
