          ...
          <div class="col-12">
            <div class="card">
                ...
                <ul class="nav nav-tabs nav-tabs-bordered" id="borderedTab" role="tablist">
                    ...
                    <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#bordered-home" type="button" role="tab" aria-controls="home" aria-selected="true">Statistic Report</button>
                    </li>
                    <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#bordered-profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Budget Report</button>
                    </li>
                    <li class="nav-item" role="presentation">
