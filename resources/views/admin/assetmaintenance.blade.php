...
<main id="main" class="main">
   ...
   <div class="alert alert-primary alert-dismissible fade show" role="alert">
    <h4 class="alert-heading" style="font-size: 1rem;">Asset Maintenance Overview</h4>
    <p style="font-size: 0.8rem; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">   Typically encompasses scheduling routine inspections, preventive maintenance tasks, and corrective repairs based on predefined maintenance schedules or condition-based triggers..  </p>
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  </div>
</br>
            ...
            <table id="dynamic_detail" cellspacing="0" style="width:100%" >
                <thead>
                  <tr>
                    ...
                    <th class="custom-tr-size ">Asset ID</th>
                    <th class="custom-tr-size ">Maintenance Date</th>
                    <th class="custom-tr-size ">Maintenance Type</th>
                    <th class="custom-tr-size ">Maintenance Description</th>
                    <th class="custom-tr-size ">Maintenance Cost</th>
                    <th class="custom-tr-size ">Maintenance Notes</th>
                    {{-- <th>Action</th> --}}
                  </tr>
                </thead>
                <tbody> </tbody>
...
$(document).ready(function(e){
     ...
     const assetdetailtable = $('#dynamic_detail').DataTable({
               ...
               columns: [
                   { data: "maintenance_id", className: "text-left custom-font-size" },
                   { data: "asset_id", className: "text-left custom-font-size" },
                   { data: "maintenance_date",className: "text-left custom-font-size" },
                   { data: "maintenance_type", className: "text-left custom-font-size" },
                   { data: "maintenance_description", className: "text-left custom-font-size" },
                   { data: "maintenance_cost",className: "text-left custom-font-size" },
                   { data: "maintenance_notes",className: "text-left custom-font-size" },
